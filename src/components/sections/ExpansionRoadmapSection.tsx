...
const milestones: MilestoneData[] = [
  ...
  },
  {
    year: '2025',
    quarter: 'Q1-Q2',
    title: 'North Bay Expansion',
    regions: ['Marin', 'Sonoma', 'Napa', 'Solano'],
    status: 'in-progress',
    highlight: 'Partner network growing',
  },
  {
    year: '2025',
    quarter: 'Q3-Q4',
    title: 'Peninsula Deep Coverage',
    regions: ['San Mateo', 'Redwood City', 'Menlo Park'],
    status: 'upcoming',
    highlight: 'Expanded same-day capacity',
  },
  {
    year: '2026',
