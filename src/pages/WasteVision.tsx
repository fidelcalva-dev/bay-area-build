      ...
      <section className="bg-background py-8 sm:py-12 border-b border-border">
        <div className="container-narrow text-center">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Not sure what size you need? Upload photos of your debris and 
            we'll recommend the right dumpster based on volume and materials.
          </p>
        </div>
      </section>
      ...
      <section className="py-6 bg-muted/30">
        <div className="container-narrow">
          <div className="text-xs text-muted-foreground text-center max-w-2xl mx-auto space-y-1">
            <p>
              <strong>Important:</strong> Estimates are based on visual analysis and may vary 
              from actual volume and weight. Final billing is determined by disposal scale ticket.
            </p>
            <p>
              For potentially hazardous materials, 
