  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">Quality gates for all SEO pages. Failing checks show as warnings â€” pages still render” pages still render” pages still render.</p>
      </div>
