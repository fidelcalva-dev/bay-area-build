...
import { DollarSign, TrendingUp, AlertTriangle, CreditCard, Receipt, Percent, Target } from 'lucide-react';
import { 
  DashboardKPICard, 
  DashboardFilters, 
  DashboardChart, 
    ...
    <div className="p-6 space-y-6">
      ...
      {kpiData.finance.length > 0 && (
        <Card>
          ...
          <CardContent>
            <KPICardGrid kpis={kpiData.finance} loading={kpiLoading} showSparkline />
          </CardContent>
        </Card>
      )}
