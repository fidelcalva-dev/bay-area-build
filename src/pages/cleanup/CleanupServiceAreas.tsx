      ...
      <section className="py-12 md:py-16">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="grid sm:grid-cols-3 gap-6 mb-10">
            <Link to="/cleanup/oakland-construction-cleanup" className="bg-card rounded-xl border border-border p-6 hover:shadow-md transition-shadow">
            ...
            <Link to="/cleanup/alameda-construction-cleanup" className="bg-card rounded-xl border border-border p-6 hover:shadow-md transition-shadow">
            ...
            <Link to="/cleanup/bay-area-construction-cleanup" className="bg-card rounded-xl border border-border p-6 hover:shadow-md transition-shadow">
