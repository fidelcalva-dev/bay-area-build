...
export const CITY_CORE_FAQ_POOL: SeoFaq[] = [
  ...
  { id: 'cc6', category: 'pricing', question: 'Is there a weight limit on dumpsters in {city}?', answer: 'General debris dumpsters include base tonnage by size (e.g., 2 tons for a 20-yard). Overage is billed at $165/ton based on scale ticket. Heavy material dumpsters (5-10 yard) are flat-fee — no weight overage charges.' },
