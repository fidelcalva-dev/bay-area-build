...
export const CITY_CORE_FAQ_POOL: SeoFaq[] = [
  { id: 'cc1', category: 'pricing', question: 'How much does a dumpster rental cost in {city}?', answer: 'Dumpster rental in {city} starts at $390 for a 6-yard container. Pricing depends on size, material type, and rental duration. Heavy materials (concrete, dirt) are flat-fee with no weight overage. General debris overage is $165/ton.' },
  ...
  { id: 'cc4', category: 'sizes', question: 'What dumpster sizes are available in {city}?', answer: 'We offer 6, 8, 10, 20, 30, 40, and 50 yard dumpsters in {city}. Heavy material dumpsters (concrete, dirt) are available in 6-10 yard sizes only. General debris dumpsters come in all sizes.' },
